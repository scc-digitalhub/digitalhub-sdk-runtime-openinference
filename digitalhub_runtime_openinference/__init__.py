...
from digitalhub_runtime_openinference.entities.run.serve.builder import RunOpeninferenceServeBuilder
...
entity_builders = (
    ...
    (EntityKinds.RUN_OPENINFERENCE_SERVE.value, RunOpeninferenceServeBuilder),
)
