...
if typing.TYPE_CHECKING:
    from digitalhub_runtime_openinference.entities.function.openinference.spec import FunctionSpecOpeninference
    from digitalhub_runtime_openinference.entities.function.openinference.status import FunctionStatusOpeninference
